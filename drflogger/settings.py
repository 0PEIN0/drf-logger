"""
Django settings for drflogger project.
...
SECRET_KEY = '$0(c9y&8%#&6b&hs8yf#9ze$tnuu1#)!#m3ns(ow&@)+j17h^z'
...
WSGI_APPLICATION = 'drflogger.wsgi.application'
